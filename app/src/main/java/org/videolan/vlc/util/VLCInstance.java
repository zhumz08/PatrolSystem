...
import cn.zhaoliugang.android.mvpviewer.MVPViewerApplication;
...
public class VLCInstance {
    ...
    public static LibVLC getLibVlcInstance() throws LibVlcException {
        ...
        if (instance == null) {
            ...
            final Context context = MVPViewerApplication.getAppContext();
...
//                	Logger.e("[VLCInstance]onNativeCrash...");
    ...
    public static void updateLibVlcSettings(SharedPreferences pref) {
        ...
        int networkCaching = pref.getInt("network_caching_value", 1000);
